...
def install_crash_handler(
    ...
    def _handler(exc_type, exc_value, exc_tb):
        ...
        # Do not call sys.__excepthook__ here.  The traceback has already
        # been persisted, and the application-level ErrorManager owns user
        # notification.  Chaining the default hook would print the same
        # exception a second time and can fail in Windows GUI builds where
        # sys.stderr is None.
