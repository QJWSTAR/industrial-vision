    ...
    def request_path_planning(
        ...
        try:
            request = Serializer.build_repair_request(
                ...
                gas_temperature_c=params.get("gas_temperature_c", 500.0),
                gas_pressure_bar=params.get("gas_pressure_bar", 30.0),
                powder_feed_rate_gmin=params.get("powder_feed_rate_gmin", 60.0),
