...
|------|-------|------|------|------|------|--------|------|
| smoke | 15 | 15 | 0 | 0 | 0 | 2.98 | PASS |
| regression | 34 | 34 | 0 | 0 | 0 | 3.24 | PASS |
...
- 覆盖率 50.65% **低于 60% 阈值**，发布前必须提升
- 各层测试累加(49)与全量(430)差异较大 (89%)，可能存在 marker 重复选择或无 marker 测试
- 未运行的测试层：export, gui, mock, performance, stress
